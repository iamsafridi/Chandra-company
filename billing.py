...
class BillClass:
    def __init__(self,root):
        ...
        #===title===
        title=Label(self.root,text='NS Traders',font=("times new roman",40,"bold"),bg='#010c48',fg='white').place(x=0,y=0,relwidth=1,height=70)

        # ===Button===
        btn_logout=Button(self.root,text='logout',command=self.logout,font=("times new roman",15,"bold"),bg='yellow',cursor='hand2').place(x=1300,y=10,height=50,width=150)
        ...
        lbl_search=Label(ProductFrame2,text='Search Products',font=('times new roman',15,'bold'),bg='white',fg='green').place(x=2,y=5)
        ...
        lbl_note=Label(ProductFrame1,text='Note:add 0 to remove item from cart',font=('goudy old style',12),bg='white',fg='red').pack(side=BOTTOM,fill=X)
        ...
        Cal_Frame=Frame(Cal_CartFrame,bd=8,relief=RIDGE,bg='white')
        ...
        btn_sub=Button(Cal_Frame,text='-',font=('arial',15,'bold'),command=lambda:self.get_inpu('-'),bd=5,width=4,pady=10,cursor='hand2').grid(row=2,column=3)
        ...
        lbl_pName=Label(ADD_CartFrame,text='Product Name',font=('times new roman',15),bg='white').place(x=5,y=5)
        ...
        lbl_pPrice=Label(ADD_CartFrame,text='Price/qty',font=('times new roman',15),bg='white').place(x=230,y=5)
        ...
        lbl_pQty=Label(ADD_CartFrame,text='Quantity',font=('times new roman',15),bg='white').place(x=390,y=5)
        txt_pQty=Entry(ADD_CartFrame,textvariable=self.var_qty,font=('times new roman',15),bg='lightyellow').place(x=390,y=35,width=120,height=22)


        self.lbl_instock=Label(ADD_CartFrame,text='In Stock',font=('times new roman',15),bg='white')
        self.lbl_instock.place(x=5,y=70)

        btn_clear_cart=Button(ADD_CartFrame,text='Clear',command=self.clear_cart,font=('times new roman',15,'bold'),bg='lightgrey',cursor='hand2').place(x=180,y=70,width=150,height=30)
        btn_add_cart=Button(ADD_CartFrame,text='Add | Update',command=self.add_update_cart,font=('times new roman',15,'bold'),bg='orange',cursor='hand2').place(x=340,y=70,width=180,height=30)
        ...
        btn_clearAll=Button(billMenuFrame,text='Clear All',cursor='hand2',command=self.clear_all,font=('goudy old style',15,'bold'),bg='grey',fg='white')
...
# =========================All Fnction==========================
    ...
    def add_update_cart(self):
        if self.var_pid.get()=='':
            ...
            messagebox.showerror('Error','Invalid Quantitiy',parent=self.root)
        else:  
    ...
    def bill_top(self):
        ...
        bill_top_temp=f'''
\t\tXYZ-Inventory
\t Phone No. 98725***** , Chapainawabganj-6300
{str("="*47)}
...
{str("="*47)}\n
    ...
    def print_bill(self):
        if self.chk_print==1:
            ...
            messagebox.showinfo('Print','Please generate bill',parent=self.root)
