...
class employeeClass:
    def __init__(self,root):
        ...
        searchFrame.place(x=270,y=20,width=600,height=70)
        ...
        btn_serach=Button(searchFrame,text='Search',command=self.search,font=('goudy old style',15),bg='#4caf50',fg='white',cursor='hand2').place(x=420,y=9,width=150,height=28)
        ...
        cmd_utype=ttk.Combobox(self.root,textvariable=self.var_utype,values=('Select','Admin','Employee'),state='readonly',justify=CENTER,font=('goudy old style',15))
        ...
        self.EmployeeTable.heading('contact',text='Conatct')
