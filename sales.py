...
class salesClass:
    def __init__(self,root):
        ...
        # ===title===
        lbl_title=Label(self.root,text='View Customer Bills',font=('goudy old style',30),bg='#184a45',fg='white',bd=2,relief=RIDGE).pack(side=TOP,fill=X,padx=10,pady=20)
        ...
        self.Sales_List=Listbox(sales_Frame,font=('roudy old style',15),bg='white',yscrollcommand=scrolly.set)
        ...
        self.bill_area.pack(fill=BOTH,expand=2)
