...
class supplierClass:
    def __init__(self,root):
        ...
        # ===searchFrame===
        # ===option====
        lbl_search=Label(self.root,text="Invoive No.",bg='white',font=('goudy old style',15))
        lbl_search.place(x=700,y=80)

        txt_serach=Entry(self.root,textvariable=self.var_searchtxt,font=('goudy old style',15),bg='lightyellow').place(x=800,y=80,width=180)

        btn_serach=Button(self.root,text='Search',command=self.search,font=('goudy old style',15),bg='#4caf50',fg='white',cursor='hand2').place(x=1000,y=79,width=100,height=28)
        ...
        self.txt_decs=Text(self.root,font=('goudy old style',15),bg='lightyellow')
        self.txt_decs.place(x=180,y=200,width=470,height=120)
